...
using static TGM.FutureRacingGP.Static.AdMobConstants;
...
public class GoogleAds : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 _randomRewardPopupTimer;
        ...
        if(_newPopupRequest)
        {
            ...
            if(_rewardInternalTimer <= 0f)
            {
                if(_popupVideoAd.IsLoaded())
                {
                    ...
                    _rewardInternalTimer = Random.Range(_randomRewardPopupTimer.x, _randomRewardPopupTimer.y);
