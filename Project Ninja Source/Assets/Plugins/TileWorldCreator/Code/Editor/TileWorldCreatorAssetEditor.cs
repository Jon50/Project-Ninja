...
namespace TWC.editor
{
	...
	public class TileWorldCreatorAssetEditor : Editor
	{
		...
		private Texture2D iconObjectLayer;
		private Texture2D iconTilesLayer;
		private Texture2D icon4TilesLayer;
		private Texture2D icon6TilesLayer;
		private Texture2D icon2DTilesLayer;
		private Texture2D iconBlueprintLayers;
		private Texture2D iconBuildLayers;
		private Texture2D iconPlus;
		private Texture2D iconUp;
		private Texture2D iconDown;
		private Texture2D iconExecute;
		private Texture2D iconRemove;
		private Texture2D iconDuplicate;
		private Texture2D iconDestroy;
		private Texture2D iconBuild;
