...
Shader "BOXOPHOBIC/The Vegetation Engine/Vegetation/Leaf Standard Lit (Deferred)"
{
	Properties
	{
		[StyledBanner(Leaf Standard Lit (Deferred))]_Banner("Banner", Float) = 0
	...
	SubShader
	{
		...
		struct Input
		{
			...
			float vertexToFrag11_g45376;
			float3 worldNormal;
			INTERNAL_DATA
			float3 vertexToFrag11_g45388;
			float vertexToFrag11_g45333;
		};
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half3 VertexPos40_g45406 = temp_output_2283_0_g45332;
			float3 appendResult74_g45406 = (float3(0.0 , VertexPos40_g45406.y , 0.0));
			float3 VertexPosRotationAxis50_g45406 = appendResult74_g45406;
			float3 break84_g45406 = VertexPos40_g45406;
			float3 appendResult81_g45406 = (float3(break84_g45406.x , 0.0 , break84_g45406.z));
			float3 VertexPosOtherAxis82_g45406 = appendResult81_g45406;
			half MotionAmplitude203095_g45332 = _MotionAmplitude_20;
			float ObjectData20_g45374 = 3.14;
			float Bounds_Radius121_g45332 = _MaxBoundsInfo.x;
			float WorldData19_g45374 = Bounds_Radius121_g45332;
			#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g45374 = WorldData19_g45374;
			#else
				float staticSwitch14_g45374 = ObjectData20_g45374;
			#endif
			float Motion_Max_Rolling1137_g45332 = staticSwitch14_g45374;
			...
			float lerpResult410_g45411 = lerp( 0.2 , 1.0 , lerpResult401_g45411);
			half Wind_Power_203109_g45332 = lerpResult410_g45411;
			half Mesh_Motion_260_g45332 = v.texcoord3.y;
			...
			float4 temp_cast_5 = (lerpResult168_g45419).xxxx;
			float4 break142_g45419 = pow( saferPower77_g45419 , temp_cast_5 );
			...
			float temp_output_3154_0_g45332 = ( _MotionVariation_20 * Motion_Variation3073_g45332 );
			float temp_output_116_0_g45417 = temp_output_3154_0_g45332;
			float temp_output_108_0_g45417 = ceil( saturate( ( frac( ( temp_output_116_0_g45417 + 0.3576 ) ) - 0.3 ) ) );
			float mulTime98_g45417 = _Time.y * 0.5;
			float lerpResult110_g45417 = lerp( temp_output_108_0_g45417 , ceil( saturate( ( frac( ( temp_output_116_0_g45417 + 0.1258 ) ) - 0.8 ) ) ) , (sin( mulTime98_g45417 )*0.5 + 0.5));
			float lerpResult118_g45417 = lerp( 0.25 , 0.75 , Wind_Power2223_g45332);
			float lerpResult111_g45417 = lerp( lerpResult110_g45417 , 1.0 , ( lerpResult118_g45417 * lerpResult118_g45417 * lerpResult118_g45417 * lerpResult118_g45417 ));
			half Input_Speed62_g45415 = _MotionSpeed_20;
			float mulTime354_g45415 = _Time.y * Input_Speed62_g45415;
			float Motion_Variation284_g45415 = temp_output_3154_0_g45332;
			float Motion_Scale287_g45415 = ( _MotionScale_20 * ase_worldPos.x );
			half Motion_Rolling138_g45332 = ( ( MotionAmplitude203095_g45332 * Motion_Max_Rolling1137_g45332 ) * ( Wind_Power_203109_g45332 * Mesh_Motion_260_g45332 * Global_NoiseTex_R34_g45332 ) * lerpResult111_g45417 * sin( ( mulTime354_g45415 + Motion_Variation284_g45415 + Motion_Scale287_g45415 ) ) );
			half Angle44_g45406 = Motion_Rolling138_g45332;
			half3 VertexPos40_g45405 = ( VertexPosRotationAxis50_g45406 + ( VertexPosOtherAxis82_g45406 * cos( Angle44_g45406 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g45406 ) * sin( Angle44_g45406 ) ) );
			...
			half Motion_Scale321_g45369 = ( _MotionScale_30 * 10.0 );
			half Input_Speed62_g45369 = _MotionSpeed_30;
			float mulTime350_g45369 = _Time.y * Input_Speed62_g45369;
			float Motion_Variation330_g45369 = ( _MotionVariation_30 * Motion_Variation3073_g45332 );
			half Input_Amplitude58_g45369 = ( _MotionAmplitude_30 * Bounds_Radius121_g45332 * 0.1 );
			float3 ase_vertexNormal = v.normal.xyz;
			half Global_NoiseTex_G38_g45332 = break142_g45419.g;
			half Global_NoiseTex_B132_g45332 = break142_g45419.b;
			half Mesh_Motion_3144_g45332 = v.texcoord3.z;
			float lerpResult378_g45411 = lerp( 0.3 , 1.0 , lerpResult401_g45411);
			half Wind_Power_303112_g45332 = lerpResult378_g45411;
			half3 Motion_Leaves1988_g45332 = ( ( sin( ( ( ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) * Motion_Scale321_g45369 ) + mulTime350_g45369 + Motion_Variation330_g45369 ) ) * Input_Amplitude58_g45369 * ase_vertexNormal ) * ( ( Global_NoiseTex_G38_g45332 + Global_NoiseTex_B132_g45332 ) * Mesh_Motion_3144_g45332 * Wind_Power_303112_g45332 ) );
			half Motion_Scale321_g45409 = ( _MotionScale_32 * 10.0 );
			half Input_Speed62_g45409 = _MotionSpeed_32;
			float mulTime349_g45409 = _Time.y * Input_Speed62_g45409;
			float Motion_Variation330_g45409 = ( _MotionVariation_32 * Motion_Variation3073_g45332 );
			half Input_Amplitude58_g45409 = ( _MotionAmplitude_32 * Bounds_Radius121_g45332 * 0.1 );
			float temp_output_299_0_g45409 = ( sin( ( ( ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) * Motion_Scale321_g45409 ) + mulTime349_g45409 + Motion_Variation330_g45409 ) ) * Input_Amplitude58_g45409 );
			float3 appendResult354_g45409 = (float3(temp_output_299_0_g45409 , 0.0 , temp_output_299_0_g45409));
			half Global_NoiseTex_A139_g45332 = break142_g45419.a;
			half Wind_Power_323115_g45332 = lerpResult376_g45411;
			float temp_output_7_0_g45353 = TVE_MotionFadeEnd;
			half Wind_FadeOut4005_g45332 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g45353 ) / ( TVE_MotionFadeStart - temp_output_7_0_g45353 ) ) );
			half3 Motion_Detail263_g45332 = ( appendResult354_g45409 * ( Global_NoiseTex_A139_g45332 * Mesh_Motion_3144_g45332 * Wind_Power_323115_g45332 ) * Wind_FadeOut4005_g45332 );
			float3 Vertex_Motion_Object833_g45332 = ( ( ( VertexPosRotationAxis50_g45341 + ( VertexPosOtherAxis82_g45341 * cos( Angle44_g45341 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g45341 ) * sin( Angle44_g45341 ) ) ) + Motion_Leaves1988_g45332 ) + Motion_Detail263_g45332 );
			float3 temp_output_3474_0_g45332 = ( PositionOS3588_g45332 - Mesh_PivotsOS2291_g45332 );
			float3 appendResult2047_g45332 = (float3(Motion_Rolling138_g45332 , 0.0 , -Motion_Rolling138_g45332));
			float3 appendResult2043_g45332 = (float3(Motion_X216_g45332 , 0.0 , Motion_Z190_g45332));
			float3 Vertex_Motion_World1118_g45332 = ( ( ( ( temp_output_3474_0_g45332 + appendResult2047_g45332 ) + appendResult2043_g45332 ) + Motion_Leaves1988_g45332 ) + Motion_Detail263_g45332 );
			#ifdef TVE_VERTEX_DATA_BATCHED
			...
			float3 tangentNormal775_g45332 = float3(0.001,0.001,1);
			float3 modWorldNormal775_g45332 = normalize( (tangentToWorld[0] * tangentNormal775_g45332.x + tangentToWorld[1] * tangentNormal775_g45332.y + tangentToWorld[2] * tangentNormal775_g45332.z) );
			float dotResult777_g45332 = dot( MainLight_Direction3926_g45332 , modWorldNormal775_g45332 );
			float temp_output_4045_0_g45332 = (-dotResult777_g45332*0.5 + 0.5);
			o.vertexToFrag11_g45376 = temp_output_4045_0_g45332;
			float3 temp_cast_15 = (1.0).xxx;
			float Mesh_Occlusion318_g45332 = v.color.g;
			float temp_output_7_0_g45377 = _VertexOcclusionMinValue;
			float3 lerpResult2945_g45332 = lerp( (_VertexOcclusionColor).rgb , temp_cast_15 , saturate( ( ( Mesh_Occlusion318_g45332 - temp_output_7_0_g45377 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g45377 ) ) ));
			float3 Vertex_Occlusion648_g45332 = lerpResult2945_g45332;
			o.vertexToFrag11_g45388 = Vertex_Occlusion648_g45332;
			float temp_output_7_0_g45378 = TVE_CameraFadeStart;
			float saferPower3976_g45332 = max( saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g45378 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g45378 ) ) ) , 0.0001 );
			float temp_output_3976_0_g45332 = pow( saferPower3976_g45332 , _FadeCameraValue );
			o.vertexToFrag11_g45333 = temp_output_3976_0_g45332;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float lerpResult3870_g45332 = lerp( 1.0 , i.vertexColor.r , _ColorsVariationValue);
			half Global_Colors_Value3650_g45332 = ( _GlobalColors * lerpResult3870_g45332 );
			...
			#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1604_g45332 = 0.0;
			#else
				float staticSwitch1604_g45332 = i.vertexToFrag11_g45376;
			#endif
			half Mask_Subsurface_Normal870_g45332 = staticSwitch1604_g45332;
			half3 Subsurface_Deferred1693_g45332 = ( Subsurface_Transmission884_g45332 * ( ( Mask_Subsurface_View782_g45332 * Blend_AlbedoColored863_g45332 ) + Mask_Subsurface_Normal870_g45332 ) );
			half3 Blend_AlbedoAndSubsurface149_g45332 = ( Blend_AlbedoColored863_g45332 + Subsurface_Deferred1693_g45332 );
			half3 Global_OverlayColor1758_g45332 = (TVE_OverlayColor).rgb;
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float lerpResult3567_g45332 = lerp( _OverlayBottomValue , 1.0 , ase_normWorldNormal.y);
			...
			float lerpResult1065_g45332 = lerp( 1.0 , i.vertexColor.r , _OverlayVariationValue);
			half Overlay_Commons1365_g45332 = ( temp_output_1025_0_g45332 * lerpResult1065_g45332 );
			float temp_output_7_0_g45418 = _OverlayMaskMinValue;
			half Overlay_Mask269_g45332 = saturate( ( ( ( ( ( lerpResult3567_g45332 * 0.5 ) + Main_AlbedoTex_G3526_g45332 ) * Overlay_Commons1365_g45332 ) - temp_output_7_0_g45418 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g45418 ) ) );
			...
			o.Albedo = ( temp_output_410_0_g45332 * i.vertexToFrag11_g45388 );
			...
			float dotResult3851_g45332 = dot( ViewDir_Normalized3963_g45332 , NormalsWS_Derivates3972_g45332 );
			float lerpResult3993_g45332 = lerp( 1.0 , abs( dotResult3851_g45332 ) , _FadeGlancingValue);
			half Fade_Glancing3853_g45332 = lerpResult3993_g45332;
			half Fade_Camera3743_g45332 = i.vertexToFrag11_g45333;
			half Final_AlphaFade3727_g45332 = ( Fade_Glancing3853_g45332 * Fade_Camera3743_g45332 );
			float temp_output_41_0_g45338 = Final_AlphaFade3727_g45332;
			float Mesh_Variation16_g45332 = i.vertexColor.r;
			float lerpResult4033_g45332 = lerp( 0.9 , (Mesh_Variation16_g45332*0.5 + 0.5) , _AlphaVariationValue);
			half Global_Extras_Alpha1033_g45332 = break49_g45361.w;
			float temp_output_4022_0_g45332 = ( lerpResult4033_g45332 - ( 1.0 - Global_Extras_Alpha1033_g45332 ) );
			half AlphaTreshold2132_g45332 = _Cutoff;
			#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g45332 = ( temp_output_4022_0_g45332 + AlphaTreshold2132_g45332 );
			#else
				float staticSwitch4017_g45332 = temp_output_4022_0_g45332;
			#endif
			float lerpResult4011_g45332 = lerp( 1.0 , staticSwitch4017_g45332 , _GlobalAlpha);
			half Global_Alpha315_g45332 = saturate( ( lerpResult4011_g45332 * _LocalAlpha ) );
			#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g45332 = ( ( Main_Alpha316_g45332 * Global_Alpha315_g45332 ) - ( AlphaTreshold2132_g45332 - 0.5 ) );
			#else
				float staticSwitch3792_g45332 = ( Main_Alpha316_g45332 * Global_Alpha315_g45332 );
			#endif
...
/*ASEBEGIN
Version=18806
1920;1;1906;1021;3665.139;1291.813;1.749375;True;False
Node;AmplifyShaderEditor.FunctionNode;610;-2176,256;Inherit;False;Define TVE_IS_VEGETATION_SHADER;-1;;40293;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;635;-2176,-384;Inherit;False;Base Shader;1;;45332;856f7164d1c579d43a5cf4968a75ca43;72,3882,1,3880,1,3957,1,4028,1,4029,1,3904,1,3903,1,3900,1,3908,1,1300,1,1298,1,3586,0,1271,1,3889,0,3658,1,1708,1,3509,1,1712,2,3873,1,1714,1,1717,1,1718,1,1715,1,916,1,1762,0,1763,0,3568,1,1949,1,1776,1,3475,1,893,1,1745,1,3479,0,3501,1,3221,2,1646,1,1690,1,1757,1,3960,0,2807,1,3886,0,2953,1,3887,0,3243,0,3888,0,3728,1,3949,0,2172,1,3883,0,2658,0,1742,1,3484,0,1735,0,3575,0,1734,0,1736,0,1733,0,1737,0,878,0,1550,0,860,1,3544,1,2261,1,2260,1,2054,1,2032,1,2060,1,2036,1,2039,1,2062,1,3592,1,2750,0;0;15;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;3678;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;629;FLOAT3;534
...
Node;AmplifyShaderEditor.RangedFloatNode;625;-1760,-1024;Half;False;Property;_IsSubsurfaceApproxShader;_IsSubsurfaceApproxShader;240;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;168;-2176,-1024;Half;False;Property;_IsLeafShader;_IsLeafShader;235;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;609;-2176,-896;Half;False;Property;_IsAnyPathShader;_IsAnyPathShader;237;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;626;-1952,-896;Half;False;Property;_IsTarget40Shader;_IsTarget40Shader;238;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;623;-2176,320;Inherit;False;Define TVE_USE_VEGETATION_BUFFERS;-1;;45331;1ad73017b051a444d8dd4dba6e00b9ca;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-1984,-1024;Half;False;Property;_IsStandardShader;_IsStandardShader;236;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;636;-1728,-896;Half;False;Property;_IsBalancedShader;_IsBalancedShader;239;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-2176,-1152;Half;False;Property;_Banner;Banner;0;0;Create;True;0;0;0;True;1;StyledBanner(Leaf Standard Lit (Deferred));False;0;0;1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=60116CF706A6A3A6B3B4D0E5F391F2C6B0ADA0E6