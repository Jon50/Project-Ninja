...
namespace TheVegetationEngine
{
    public class TVEShaderUtils
    {
        public static void SetMaterialSettings(Material material)
        {
            ...
            // Set Detail Maps
            if (material.HasProperty("_DetailMapsMode") && material.HasProperty("_SecondColor"))
            {
            ...
            // Invert mesh mask if the final blend is inverted
            if (material.HasProperty("_DetailMapsMode") && material.HasProperty("_SecondColor"))
            {
                if (material.GetInt("_DetailMapsMode") == 0)
                {
        ...
        public static void DrawTechnicalDetails(Material material)
        {
            ...
            if (material.HasProperty("_IsBalancedShader"))
            {
            ...
            if (material.HasProperty("_IsTarget20Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 2.0 or higher", styleLabel);
            }

            if (material.HasProperty("_IsTarget30Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 3.0 or higher", styleLabel);
            }

            if (material.HasProperty("_IsTarget35Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 3.5 or higher", styleLabel);
            }

            if (material.HasProperty("_IsTarget40Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 4.0 or higher", styleLabel);
            }

            if (material.HasProperty("_IsTarget45Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 4.5 or higher", styleLabel);
            }

            if (material.HasProperty("_IsTarget46Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 4.6 or higher", styleLabel);
            }

            if (material.HasProperty("_IsTarget50Shader"))
            {
                DrawTechincalLabel("Render Target: Shader Model 5.0", styleLabel);
            }
            ...
            if (material.HasProperty("_IsSubsurfaceApproxShader"))
            {
            ...
            {
                DrawTechincalLabel("Render Buffer: Rendered by Colors type buffers", styleLabel);
            }

            if (material.HasProperty("_IsExtrasShader"))
            {
                DrawTechincalLabel("Render Buffer: Rendered by Extras type buffers", styleLabel);
            }

            if (material.HasProperty("_IsMotionShader"))
            {
                DrawTechincalLabel("Render Buffer: Rendered by Motion type buffers", styleLabel);
            }

            if (material.HasProperty("_IsCustomShader"))
            {
                DrawTechincalLabel("Render Buffer: Rendered by Custom type buffers", styleLabel);
            }
