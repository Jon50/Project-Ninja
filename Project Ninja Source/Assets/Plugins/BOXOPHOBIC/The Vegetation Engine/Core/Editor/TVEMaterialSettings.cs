...
namespace TheVegetationEngine
{
    public class TVEMaterialSettings : EditorWindow
    {
        ...
        List<TVEMaterialData> subsurfaceData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_MainLightScatteringValue", "Light Scattering Intensity", -9999, 0, 16, false, true),
            new TVEMaterialData("_MainLightAngleValue", "Light Scattering Angle", -9999, 0, 16, false, false),
        };
        ...
        List<TVEMaterialData> motionData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_MotionAmplitude_30", "Leaves Amplitude", -9999, 0, 2, false, true),
            new TVEMaterialData("_MotionSpeed_30", "Leaves Speed", -9999, 0, 60, true, false),
            new TVEMaterialData("_MotionScale_30", "Leaves Scale", -9999, 0, 20, false, false),
            new TVEMaterialData("_MotionVariation_30", "Leaves Variation", -9999, 0, 20, false, false),
        ...
        void OnGUI()
        {
            ...
            else
            {
                ...
                {
                    EditorGUILayout.HelpBox("Select a gameObject or multiple gameObjects to get started!", MessageType.Info, true);
                }
            }
            ...
            else if (settingsIndex == 10)
            {
                ...
                {
                    GUILayout.Space(10);
                    EditorGUILayout.HelpBox("Procedural variation in use! Use the Scale settings if the Variation is breaking the bending and rolling animation!", MessageType.Warning, true);
                }
            }
            else
            {
        ...
        {
            Vector4 windParams = Shader.GetGlobalVector("TVE_VertexParams");
            Shader.SetGlobalVector("TVE_VertexParams", new Vector4(windParams.x, windParams.y, windPower * 0.5f + 0.5f, 1.0f));
