    ...
    public class TVEElement : StyledMonoBehaviour
    {
        ...
        void AddElementToVolume()
        {
            ...
            if (gameObject.GetComponent<MeshRenderer>() != null && gameObject.GetComponent<MeshRenderer>().sharedMaterial != null)
            {
                ...
                var data = new TVEElementDrawerData(ElementType.Undefined, ElementLayer.Any, RendererType.Mesh, gameObject, gameObject.GetComponent<MeshFilter>().sharedMesh, renderer);
            ...
            else if (gameObject.GetComponent<ParticleSystemRenderer>() != null && gameObject.GetComponent<ParticleSystemRenderer>().sharedMaterial != null)
            {
                ...
                var material = renderer.sharedMaterial;
                var data = new TVEElementDrawerData(ElementType.Undefined, ElementLayer.Any, RendererType.Particle, gameObject, new Mesh(), renderer);
            ...
            else if (gameObject.GetComponent<TrailRenderer>() != null && gameObject.GetComponent<TrailRenderer>().sharedMaterial != null)
            {
                ...
                var material = renderer.sharedMaterial;
                var data = new TVEElementDrawerData(ElementType.Undefined, ElementLayer.Any, RendererType.Trail, gameObject, new Mesh(), gameObject.GetComponent<Renderer>());
        ...
        void AddElementByType(Material material, TVEElementDrawerData data)
        {
            ...
            else if (material.HasProperty("_IsVertexShader"))
            {
                data.elementType = ElementType.Vertex;
                validType = true;
            }
            else if (material.HasProperty("_IsCustomShader"))
            {
                data.elementType = ElementType.Custom;
                validType = true;
            }
