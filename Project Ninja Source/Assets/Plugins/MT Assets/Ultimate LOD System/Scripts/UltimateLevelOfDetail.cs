    ...
    */
    ...
    public class UltimateLevelOfDetail : MonoBehaviour
    {
        ...
        private void CreateHierarchyOfFoldersIfNotExists()
        {
            ...
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData", "Meshes");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_1"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_1");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_2"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_2");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_3"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_3");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_4"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_4");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_5"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_5");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_6"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_6");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_7"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_7");
            if(!AssetDatabase.IsValidFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_8"))
                AssetDatabase.CreateFolder("Assets/Plugins/MT Assets/_AssetsData/Meshes", "LODs_8");
#endif
        }
        ...
        private string SaveGeneratedLodInAssets( string lodNumber, long ticks, Mesh generatedLodMesh )
        {
            ...
            {
                string path = "Assets/Plugins/MT Assets/_AssetsData/Meshes/LODs_" + lodNumber + "/LOD" + lodNumber + "_" + ticks + ".asset";
